...
public class Enum
{
	public static enum STATUS {RUNNING, STOP}

	// 描画の初期位置
	public static enum POSITION {A, B, C}

	// 移動速度
	public static enum SPEED {A, B, C, D, E}

	// 描画時間
	public static enum DURATION {A, B, C, D, E}

	// 描画するかどうか
	public static enum VISIBILITY {VISIBLE, INVISIBLE}
