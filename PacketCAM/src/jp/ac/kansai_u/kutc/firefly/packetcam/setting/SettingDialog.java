...
//                    // 解像度
//                    // 対応する画像サイズのリストを取得
//                    final List<Camera.Size> supportedPictureSize = DrawCamera.getCamera().getParameters().getSupportedPictureSizes ();
//                    // 画像サイズの個数を取得
...
//                        public void onClick (DialogInterface dialog, int which)
//                        {
//                            Camera.Parameters parameter = DrawCamera.getCamera().getParameters();
//
...
//                            DrawCamera.getCamera().setParameters(parameter);
//                            // 設定ファイルに保存
